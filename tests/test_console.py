...
class TestHBNBCommand_show(unittest.TestCase):
    ...
    def test_show_invalid_class(self):
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            self.assertEqual(correct, output.getvalue().strip())
OBOBOB        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("MyModel.show()"))
            self.assertEqual(correct, output.getvalue().strip())
OBOBOB
    def test_show_missing_id_space_notation(self):
OBOBOB        correct = "** instance id missing **"
        with patch("sys.stdout", new=StringIO()) as output:
...
OBOBOB        with patch("sys.stdout", new=StringIO()) as output:
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            self.assertEqual(correct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
OAOAOA            self.assertFalse(HBNBCommand().onecmd("show Place"))
            self.assertEqual(correct, output.getvalue().strip())
OAOAOA        with patch("sys.stdout", new=StringIO()) as output:
OAOAOA            self.assertFalse(HBNBCommand().onecmd("show Review"))
            self.assertEqual(correct, output.getvalue().strip())
OAOAOA
...
class TestHBNBCommand_update(unittest.TestCase):
    ...
    def test_update_missing_attr_name_space_notation(self):
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create City"))
OAOAOA            testId = output.getvalue().strip()
...
OAOAOA        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd("create Amenity"))
            testId = output.getvalue().strip()
OAOAOA            testCmd = "update Amenity {}".format(testId)
        with patch("sys.stdout", new=StringIO()) as output:
            self.assertFalse(HBNBCommand().onecmd(testCmd))
            self.assertEqual(correct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_update_missing_attr_value_space_notation(self):
        ...
        with patch("sys.stdout", new=StringIO()) as output:
            ...
            self.assertEqual(correct, output.getvalue().strip())
OBOBOB        with patch("sys.stdout", new=StringIO()) as output:
OBOBOB            HBNBCommand().onecmd("create Place")
            testId = output.getvalue().strip()
OBOBOB        with patch("sys.stdout", new=StringIO()) as output:
            testCmd = "update Place {} attr_name".format(testId)
OBOBOB            self.assertFalse(HBNBCommand().onecmd(testCmd))
            self.assertEqual(correct, output.getvalue().strip())
        with patch("sys.stdout", new=StringIO()) as output:
    ...
    def test_update_valid_string_attr_space_notation(self):
        ...
        with patch("sys.stdout", new=StringIO()) as output:
OAOAOA            HBNBCommand().onecmd("create State")
            testId = output.getvalue().strip()
        testCmd = "update State {} attr_name 'attr_value'".format(testId)
OAOAOA        self.assertFalse(HBNBCommand().onecmd(testCmd))
        test_dict = storage.all()["State.{}".format(testId)].__dict__
OAOAOA        self.assertEqual("attr_value", test_dict["attr_name"])

        with patch("sys.stdout", new=StringIO()) as output:
OAOAOA            HBNBCommand().onecmd("create City")
            testId = output.getvalue().strip()
...
OAOAOA        self.assertFalse(HBNBCommand().onecmd(testCmd))
        ...
        self.assertFalse(HBNBCommand().onecmd(testCmd))
OAOAOA        test_dict = storage.all()["Review.{}".format(testId)].__dict__
OAOAOA        self.assertTrue("attr_value", test_dict["attr_name"])
OAOAOA
    def test_update_valid_string_attr_dot_notation(self):
OAOAOA        with patch("sys.stdout", new=StringIO()) as output:
            HBNBCommand().onecmd("create BaseModel")
OAOAOA            tId = output.getvalue().strip()
        testCmd = "BaseModel.update({}, attr_name, 'attr_value')".format(tId)
        self.assertFalse(HBNBCommand().onecmd(testCmd))
OAOAOA        test_dict = storage.all()["BaseModel.{}".format(tId)].__dict__
        self.assertEqual("attr_value", test_dict["attr_name"])
    ...
    def test_update_valid_dictionary_with_int_space_notation(self):
        ...
        HBNBCommand().onecmd(testCmd)
OBOBOB        test_dict = storage.all()["Place.{}".format(testId)].__dict__
        self.assertEqual(98, test_dict["max_guest"])
OBOBOB
    def test_update_valid_dictionary_with_int_dot_notation(self):
        ...
        testCmd = "Place.update({}, ".format(testId)
        testCmd += "{'max_guest': 98})"
OAOAOA        HBNBCommand().onecmd(testCmd)
        test_dict = storage.all()["Place.{}".format(testId)].__dict__
OAOAOA        self.assertEqual(98, test_dict["max_guest"])
OAOAOA
    def test_update_valid_dictionary_with_float_space_notation(self):
OAOAOA        with patch("sys.stdout", new=StringIO()) as output:
OAOAOA            HBNBCommand().onecmd("create Place")
            testId = output.getvalue().strip()
OAOAOA        testCmd = "update Place {} ".format(testId)
